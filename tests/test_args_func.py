...
from tests.example import args_dec, args_func
...
def test_decorator_with_args_function_with_args():
    ...
    assert args_func.function_with_args("value1", arg2="value2") == "function_with_args: value1 value2 done"
...
def test_introspection():
    assert args_func.function_with_args.__name__ == "function_with_args"
...
def test_mock_decorator():
    ...
    decorator_with_args.function_with_args.assert_called_once_with("arg1", arg2="arg2")
    assert args_func.function_with_args("value1", arg2="value2") == "function_with_args: value1 value2 done"
